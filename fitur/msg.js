...
module.exports = async(conn, msg, m, setting, store) => {
    ...
    const readmore = more.repeat(4001)
		...
		const buttonsDefault = [
			{ urlButton: { displayText: `GRUP Delta-BOT`, url : `https://chat.whatsapp.com/HECLovHbCI6LVVH4Q8FN2C` } },
		...
		const button5 = [
			...
			{ urlButton: { displayText: `GROUP SUPPORT`, url : `https://chat.whatsapp.com/HECLovHbCI6LVVH4Q8FN2C` } },
